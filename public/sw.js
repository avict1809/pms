...
const STATIC_CACHE = 'pms-static-v1.0.0';
const DYNAMIC_CACHE = 'pms-dynamic-v1.0.0';
...
async function handleStaticRequest(request) {
  ...
  try {
    ...
    console.log('Service Worker: Static file not found in cache', error);
...
async function handleExternalRequest(request) {
  ...
  try {
    ...
    console.log('Service Worker: External resource not available', error);
    return new Response('Offline', { status: 503 });
  }
}
