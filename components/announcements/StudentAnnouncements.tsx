...
export default function StudentAnnouncements({
  ...
  const fetchAnnouncements = async () => {
    try {
      ...
      if (response.ok) {
        // Filter announcements relevant to students
        const studentAnnouncements = result.data.filter(
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-neutral-400 mt-1">
            Stay updated with announcements relevant to students
          </p>
        </div>
        <Button
          variant="outline"
            ...
            <CardContent className="p-12 text-center">
              ...
              <p className="text-neutral-400">
                {searchTerm || filterType !== "all"
                  ...
                  : "No student-specific announcements have been posted yet"}
              </p>
            </CardContent>
          </Card>
        )}
